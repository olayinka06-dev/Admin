...
export default function SettingPreference() {
    return (
        <div className="">
            <div className=" mt-[30px] p-[28px] border border-[rgba(0,0,0,0.1)] rounded-[20px]">
                ...
                <div className="container mx-auto flex lg:flex-row flex-col lg:gap-[0] gap-[10px] lg:space-x-[10px]">
                    ...
                    <div className="mx-auto flex lg:space-x-[10px] border border-[rgba(0,0,0,0.1)]   py-[10px] lg:px-[20px] px-[10px] rounded-[10px] outline-none">
                    ...
                    <div className="mx-auto flex space-x-[10px] border border-[rgba(0,0,0,0.1)]  py-[10px] px-[20px] rounded-[10px] outline-none">
